...
export type RepositoryQuery = (
  ...
  & { repository: Maybe<(
    { __typename?: 'Repository' }
    & Pick<Repository, 'name' | 'id'>
    & { collaborators: Maybe<(
      { __typename?: 'RepositoryCollaboratorConnection' }
      & { nodes: Maybe<Array<Maybe<(
        { __typename?: 'User' }
        & Pick<User, 'id' | 'name' | 'login' | 'email'>
      )>>> }
    )> }
  )> }
);
...
export type SearchQuery = (
  ...
  & { search: (
    { __typename?: 'SearchResultItemConnection' }
    & { nodes: Maybe<Array<Maybe<{ __typename?: 'Issue' } | { __typename?: 'PullRequest' } | (
      { __typename?: 'Repository' }
      & Pick<Repository, 'id' | 'nameWithOwner' | 'description' | 'shortDescriptionHTML' | 'forkCount' | 'updatedAt' | 'name'>
      & { repositoryTopics: (
        { __typename?: 'RepositoryTopicConnection' }
        & { nodes: Maybe<Array<Maybe<(
          { __typename?: 'RepositoryTopic' }
          & Pick<RepositoryTopic, 'id' | 'resourcePath' | 'url'>
          & { topic: (
            { __typename?: 'Topic' }
            & Pick<Topic, 'id' | 'name'>
          ) }
        ...
        { __typename?: 'License' }
        & Pick<License, 'id' | 'nickname' | 'name' | 'spdxId'>
      )>, owner: (
        { __typename?: 'Organization' }
        & Pick<Organization, 'id' | 'login'>
      ) | (
        { __typename?: 'User' }
        & Pick<User, 'id' | 'login'>
      ), primaryLanguage: Maybe<(
        { __typename?: 'Language' }
        & Pick<Language, 'id' | 'name' | 'color'>
      )> }
    ) | { __typename?: 'User' } | { __typename?: 'Organization' } | { __typename?: 'MarketplaceListing' } | { __typename?: 'App' }>>>, edges: Maybe<Array<Maybe<(
      { __typename?: 'SearchResultItemEdge' }
...
export const RepositoryDocument = gql`
  ...
  export class RepositoryGQL extends Apollo.Query<RepositoryQuery, RepositoryQueryVariables> {
